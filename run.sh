...
do
    ...
    ./bin/apps/rwdomination file ../../raid0_efghij/crawl.txt shardsize 1048576 nvertices 3563602788
done
...
echo "HDD shardsize = 1048576, App = PPR, Dataset = LJ" >> graphwalker_metrics.txt.statistics 
for(( times = 0; times < 5; times++))
do
    echo "times = " $times " from echo"
...
# echo "HDD shardsize = 1048576, App = SimRank, Dataset = LJ" >> graphwalker_metrics.txt.statistics 
# for(( times = 0; times < 5; times++))
# do
#     echo "times = " $times " from echo"
