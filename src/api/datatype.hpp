...
#define	WALK_BUFFER_SIZE	20480 // most 1024 walks in a in-memory walk buffer
#define	MEM_BUDGET	56 * 1024 * 1024 // for 64GB memory machine
// #define	MEM_BUDGET	6 * 1024 * 1024 // for 8GB memory machine
