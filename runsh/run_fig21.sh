# # msppr -- kk_ppr 
# echo "app = msppr, dataset = Twitter from echo" >> graphwalker_metrics.txt.statistics 
...
#     free -m
#     ./bin/apps/msppr file ../../data/raid0_defghij_ssd/datasets_for_GraphWalker/Twitter/twitter-rv.undirected-reorder firstsource 12 numsources 61578415 blocksize_kb 16384 maxwalklength 16384 walkspersource 1
# done
...
#     sync; echo 1 > /proc/sys/vm/drop_caches
#     free -m
#     ./bin/apps/msppr file ../../data/raid0_defghij_ssd/datasets_for_GraphWalker/Friendster/out.friendster-undir-reorder firstsource 0 numsources 68349467 blocksize_kb 2048 maxwalklength 16384 walkspersource 1
# done
