...
do
    ...
    sync; echo 1 > /proc/sys/vm/drop_caches
    free -m
    ./bin/apps/msppr file ../../data/raid0_defghij_ssd/Friendster/out.friendster-reorder firstsource 13 numsources 1 blocksize_kb 2048
done
...
do
    ...
    sync; echo 1 > /proc/sys/vm/drop_caches
    free -m
    ./bin/apps/msppr file ../../data/raid0_defghij_ssd/datasets_for_GraphWalker/Yahoo/yahoo-webmap.txt firstsource 9 numsources 1 blocksize_kb 2048
done
...
do
    ...
    sync; echo 1 > /proc/sys/vm/drop_caches
    free -m
    ./bin/apps/msppr file ../../data/raid0_defghij_ssd/datasets_for_GraphWalker/Kron31/kron31_32-sorted.txt firstsource 0 numsources 1 blocksize_kb 131072
done
...
do
    ...
    sync; echo 1 > /proc/sys/vm/drop_caches
    free -m
    ./bin/apps/simrank file ../../data/raid0_defghij_ssd/datasets_for_GraphWalker/Kron31/kron31_32-sorted.txt blocksize_kb 131072 a 0 b 6
done
...
do
    ...
    sync; echo 1 > /proc/sys/vm/drop_caches
    free -m
    ./bin/apps/graphlet file ../../data/raid0_defghij_ssd/datasets_for_GraphWalker/Twitter/twitter_rv.net N 61578415 blocksize_kb 16384
done
...
do
    ...
    sync; echo 1 > /proc/sys/vm/drop_caches
    free -m
    ./bin/apps/graphlet file ../../data/raid0_defghij_ssd/datasets_for_GraphWalker/Kron31/kron31_32-sorted.txt N 2147483648 blocksize_kb 131072
done
...
do
    ...
    sync; echo 1 > /proc/sys/vm/drop_caches
    free -m
    ./bin/apps/rwdomination file ../../data/raid0_defghij_ssd/datasets_for_GraphWalker/Kron31/kron31_32-sorted.txt N 2147483648 blocksize_kb 131072
done
