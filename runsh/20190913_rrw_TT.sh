...
# echo "2019.9.13 " >> graphwalker_metrics.txt.statistics 
# echo "R * L impact for rawrandomwalks, dataset = Twitter, SSD" >> graphwalker_metrics.txt.statistics 
...
# ## rawrandomwalks
# echo "app = rawrandomwalks, dataset = Twitter from echo" >> graphwalker_metrics.txt.statistics
...
#         free -m
#         ./bin/apps/rawrandomwalks file ../../raid0_defghij/Twitter/twitter_rv.net N 61578415 R $R L 10
#     done
# done
...
do
    ...
    do
        ...
        sync; echo 1 > /proc/sys/vm/drop_caches
        free -m
        ./bin/apps/rawrandomwalks file ../../raid0_defghij/Twitter/twitter_rv.net N 61578415 R 100000 L $L
    done
done
...
# echo "Raw Random walks from echo, L = 10, vary R from 10^3 to 10^10"  >> graphwalker_metrics.txt.statistics
# ## rawrandomwalks
# echo "app = rawrandomwalks, dataset = Kron30 from echo" >> graphwalker_metrics.txt.statistics
# for(( R = 1000; R <= 10000000000; R*=10))
# do
#     echo "R = " $R ", fixed L = 10, from echo" >> graphwalker_metrics.txt.statistics 
#     for(( times = 0; times < 5; times++))
